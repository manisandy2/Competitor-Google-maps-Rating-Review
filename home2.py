...
wb = load_workbook(r"D:\projects\competitor_maps_review\excel\Competitor\Competitor\Home Appliance Stores2.xlsx")
ws = wb.active
...
for r in range(2,ws.max_row+1):
    try:
        ...
        wb.save(r"D:\projects\competitor_maps_review\save data\Home Appliance Stores2 "+ date + ".xlsx")
    except:
        pass