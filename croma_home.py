...
wb = load_workbook(r"D:\projects\competitor_maps_review\excel\Competitor\Competitor\Croma Stores New Link home.xlsx")
ws = wb.active
...
for r in range(2,ws.max_row+1):
    try:
        ...
        wb.save(r"D:\projects\competitor_maps_review\save data\Croma Stores New Link home "+ date + ".xlsx")
    except:
        pass