...
wb = load_workbook(r"D:\projects\competitor_maps_review\excel\Competitor\Competitor\Priyadharsini Mobiles Store Links.xlsx")
...
for r in range(2,ws.max_row+1):
    ...
    wb.save(r"D:\projects\competitor_maps_review\save data\Priyadharsini Stores report "+ date + ".xlsx")