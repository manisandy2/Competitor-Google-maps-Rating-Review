...
wb = load_workbook(r"D:\projects\competitor_maps_review\excel\Competitor\Competitor\Celekt Mobiles Stores Link.xlsx")
...
for r in range(2,ws.max_row+1):
    try:
        ...
        wb.save(r"D:\projects\competitor_maps_review\save data\Celekt Mobiles report " + date +".xlsx")
    except:
        pass